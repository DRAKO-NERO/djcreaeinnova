...
<div class="container fondo-personalizado">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><?php echo e(__('Inicio de Sesion')); ?></div>
                            ...
                            <div class="col-md-8 offset-md-4">
                                ...
                                <?php if(Route::has('password.request')): ?>
                                    <a class="btn btn-link" href="<?php echo e(route('password.request')); ?>">
                                        <?php echo e(__('Olvidaste contraseña?')); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\www.djcreaeinnova.com\resources\views/auth/login.blade.php ENDPATH**/ ?>
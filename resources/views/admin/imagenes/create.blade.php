...
<script src="https://cdn.ckeditor.com/4.22.1/standard/ckeditor.js"></script>
      ...
      <div class="container-fluid">
        <div class="row mb-2 align-items-center">
          <div class="col-12 col-sm-6 text-center text-sm-left">
            <h1 class="m-0 font-weight-bold text-dark fs-4">Nueva Imagen</h1>
          </div><!-- /.col -->  
            ...
            <div class="card card-primary card-outline shadow-sm">
              <div class="card-header">
                <h5 class="m-0 font-weight-bold text-primary">
                  <i class="fas fa-image mr-1"></i> Registre los Datos de la Imagen
                </h5>
              </div>
              ...
              <div class="card-body">
                <form action="{{ url('/admin/imagenes') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row g-3">
                        ...
                        <!-- Columna Izquierda: Título, archivo e imagen previa -->
                        <div class="col-12 col-md-6">
                            
                            <div class="form-group mb-3">
                                <label for="titulo_i" class="font-weight-bold">Título de la Imagen <span class="text-danger">*</span></label>
                                <input type="text" name="titulo_i" id="titulo_i" class="form-control" value="{{ old('titulo_i') }}" placeholder="Ingrese el título de la imagen" required>
                                @error('titulo_i')
                            ...
                            <div class="form-group mb-3">
                                <label for="file" class="font-weight-bold">Portada de la Imagen <span class="text-danger">*</span></label>
                                <input type="file" name="imagen_i" id="file" class="form-control-file border rounded p-1 w-100" required>
                                @error('imagen_i')
                                    <small class="text-danger d-block mt-1">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea name="descripcion_i" id="descripcion_i" cols="30" rows="5" class="form-control" required>{{ old('descripcion_i') }}</textarea>
                                @error('descripcion_i')
                                    <small class="text-danger d-block mt-1">{{ $message }}</small>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        <div class="col-12 d-flex flex-wrap justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save mr-1"></i> Registrar Imagen
                            </button>
                        </div>
                    </div>
    ...
    <script>
        ...
        // Función para previsualizar imagen seleccionada de forma responsive

...
<head>
    ...
    <style>
        /* Estilos de soporte para que el contenido de la descripción nunca rompa el layout */
        ...
        /* Envoltorio responsivo para el video (soporta videos de YouTube Shorts o horizontales) */
        .video-container-responsive {
            position: relative;
            width: 100%;
            max-width: 320px;
            /* Si tus videos son formato Shorts/Vertical (9:16) mantenemos 500px como alto máximo adaptable */
            min-height: 380px;
            height: 70vh; 
            max-height: 520px;
            border-radius: 8px;
...
<div class="container text-center overflow-hidden">
    <h1 class="titulo1 animate__animated animate__slideInDown mb-0">DJ CREA E INNOVA</h1>
</div>
...
<div class="container my-2" style="background-color: #00000083; border-radius: 10px; box-shadow: 0px 0px 10px #000000; padding: 15px;">
    <div class="card card-primary card-outline border-0 bg-white rounded-3">
        ...
        <div class="card-header bg-white border-bottom py-3">
            <h3 class="m-0 text-dark fw-bold text-center text-md-start fs-4 fs-md-3">{{ $video->titulo_v }}</h3>
        </div>
        ...
        <div class="card-body p-3 p-md-4 text-start">
            <div class="row align-items-start g-4">
                ...
                <div class="col-12 col-md-5 col-lg-4 text-center">
                    ...
                    <div class="video-container-responsive mx-auto shadow-sm">
                ...
                <div class="col-12 col-md-7 col-lg-8">
                    ...
                    <div class="descripcion-contenido p-1 p-md-2 text-break" style="font-size: 1rem; line-height: 1.6; color: #333;">
                        {!! $video->descripcion_v !!}
                    </div>
                </div>

          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary card-outline">
              <div class="card-header">
                <h3 class="m-0">{{$video->titulo_v}}</h3>
              </div>
              <div class="card-body">
                <table class="table table-bodered border-hover table-striped">
                  ...
                  <tbody>
                      ...
                      <tr>
                        <td>
                            <iframe width="100%" height="400" src="https://www.youtube.com/embed/{{ $video->video_url_v }}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                        </td>
